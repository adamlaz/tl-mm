...
9. [Week 1: Pre-Work](#9-week-1-pre-work-15-hrs-async--5-hrs-meetings)
10. [Week 2: Onsite Diagnostic Sprint](#10-week-2-onsite-diagnostic-sprint-30-hrs-onsite--10-hrs-async)
11. [Interview Framework](#11-interview-framework)
12. [Artifacts to Build During Onsite](#12-artifacts-to-build-during-onsite)
13. [Week 3: Analysis, Synthesis & Deliverables](#13-week-3-analysis-synthesis--deliverables-20-hrs)
...
An ~80-hour compressed diagnostic sprint to give Don an executable map of how Mad Mobile actually works, where execution breaks down, and what to fix first — without triggering a fear spiral inside the org.
...
| Onsite | Dates TBD | 3–5 day sprint in Tampa: 15+ interviews, architecture walkthroughs, value stream mapping, decision-rights mapping, real case tracing |
...
Collaborative and systems-focused — not a blame exercise. All individual interview content is anonymous; only systemic patterns are reported. Compensation is a one-time fixed fee with friendly deferred terms (specifics TBD); an ongoing advisory role via FAST agreement is a separate conversation if warranted. Total estimated effort: ~80 hours across 3 weeks.
...
**Scope**: Product decision-making, engineering organization and delivery, architecture and platform strategy, cross-functional workflows, operating cadence, business-technology alignment, AI strategy (aspiration vs. reality), and major systemic blockers.
...
**Timeline**: 3 weeks. Pre-Work: async + alignment sessions (now through onsite). Onsite: diagnostic sprint. Deliverables: week after onsite.

**Estimated effort**: ~80 hours total. Pre-work: 15 hrs async + 5 hrs meetings. Onsite: 30 hrs onsite + 10 hrs async. Deliverables: 20 hrs async + meetings.
...
| Name | Title | Notes |
|---|---|---|
| **Chathura Ratnayake** | SVP Global Software Engineering | **Primary engineering leader.** Per Don, basically runs most of tech even though much of it doesn't formally report to him. Key engagement contact. Direct reports: Akshay Bhasin, Matthew Crumley, Randall Brown. |
...
| Dulanjan Wengappuliarachchi | Sr. Director Product Management | Product management sits under CTO, not a separate product org. Reports: Mirunaaliny Somasunthara Iyer, Thaddeus Fox, Richard Farber. |
...
These frameworks are layered, not stacked. The pre-work deploys lightweight assessments (DORA Quick Check, DevEx survey, Westrum culture survey, Pragmatic Engineer Test). The onsite week uses workshop-driven frameworks (Value Stream Mapping, RAPID decision mapping, Wardley Mapping, Team Topologies classification). Week 3 deliverables are organized using the PE DD pillar structure and Watkins' STARS model.
...
The full scope of the engagement is compressed into three weeks by leveraging AI-augmented tooling for automated system analysis, note-taking, documentation synthesis, and pattern identification. Pre-work begins immediately and runs through the onsite date. The more lead time, the more value the onsite delivers.

### 8.1 Timeline Overview

| Phase | Timeline | Focus | Effort |
|---|---|---|---|
| Pre-Work | Now → Onsite | CEO alignment, hypothesis building, pre-read analysis, automated system reconnaissance, interview scheduling, internal messaging | 15 hrs async + 5 hrs meetings (20 hrs) |
| Onsite | Dates TBD | Diagnostic sprint: leadership interviews, team interviews, artifact review, system walkthroughs, value-stream tracing, real case tracing | 30 hrs onsite + 10 hrs async (40 hrs) |
| Deliverables | Week after Onsite | Pattern validation, synthesis, friction register, CEO operating brief, 30/60/90 plan, optional board deck | 20 hrs async + meetings |

**Total estimated effort: ~80 hours.** AI augmentation handles the bulk of system scanning, documentation ingestion, interview transcription, and pattern analysis, freeing Adam's hours for the high-judgment work: interviews, interpretation, and synthesis.

---

## 9. Week 1: Pre-Work (15 hrs async + 5 hrs meetings)
...
Deploy four lightweight, established assessments to engineering leads and ICs before the onsite. A critical positioning note: many people at Mad Mobile have felt their voices were unheard or ignored under previous leadership. These surveys are not just data collection — they're a concrete signal that new leadership is listening. When introduced with the right framing from Don, the act of asking becomes as valuable as the answers.
...
- Current roadmap(s) for each product line
...
| Bill Lodes (CRO) | Wed | 45 min | Sales pipeline, feature promises, deal blockers, tech support escalation |
...
| Senior ICs (2–3) | Tue/Wed | 30 min each | Unfiltered ground-level perspective |
...
| Chris Gomersall (Dir Product Design) | Wed | 30 min | Design process, collaboration with product/eng |
...
| Greg Schmitzer (President) | Thu | 30 min | Partnerships, GTM, his operating role |
...
- **System access:** Guest/read-only access to GitHub, Jira, AWS console (read-only), monitoring dashboards, internal wiki. Arrange during pre-work period.
...
## 10. Week 2: Onsite Diagnostic Sprint (30 hrs onsite + 10 hrs async)

The onsite week is a structured diagnostic sprint. The majority of time is spent in interviews, artifact walkthroughs, and observation — not receiving slide decks. AI-augmented note-taking captures everything; Adam focuses on listening, probing, and reading the room.
...
Async evening work (~2 hrs/night): AI-assisted synthesis of interview notes, cross-referencing against automated system data, updating live artifacts. By processing each day's findings same-day, the next morning's interviews are informed by the previous day's patterns.
...
- **Tuesday — Engineering Deep Dive & Reality Testing.**
  ...
  - Meet VP Software Engineering (Zubair Syed), enterprise technology, senior ICs.
  - Facilitate Three Horizons classification of current engineering projects.
  - ***Goal: find where reality deviates from the official story.***

- **Wednesday — Cross-Functional Tracing & Decision Rights Mapping.**
  ...
  - Apply Flow Framework work-type analysis.
  - ***Goal: move from anecdote to pattern.***

- **Thursday — Validation, Gaps & Preliminary Playback.**
  - Follow up on surprises.
  - Fill interview gaps. Meet Greg Schmitzer (President) — understand his operating role.
  ...
  - If Don wants, do a brief leadership playback of preliminary themes. Begin forming the deliverable narrative.

- **Friday — Wrap & Synthesis.**
  - Morning: final debrief with Don, review hypothesis scorecard, friction register draft, and STARS diagnosis.
  - Score each of the PE Tech DD 9 Pillars on a preliminary maturity scale.
  - Identify remaining gaps to address async in Week 3.
  - Afternoon: transition to deliverable production.
...
## 13. Week 3: Analysis, Synthesis & Deliverables (20 hrs)
...
One-time fixed fee for the three-week engagement. We've discussed keeping the payment terms friendly and deferred for Mad Mobile — specifics to be worked out before onsite. The intent is to remove financial friction during the transition so we can focus on delivering value first. We'll figure out the exact number and timing through conversation, not in this document.
