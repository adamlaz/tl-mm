# Mad Mobile Engagement — State Update: April 3, 2026 Reorg

**Apply these changes to `mad-mobile-engagement-state.md`**

---

## REPLACE: Section 3 — Key People
...
5. **David Strainick — MOVED from CPO to COO.** Now owns Account Management, Onboarding, Delivery, and IT. IT (Jorge Maltes → Rosen Georgiev) now reports through COO, not CTO. **Open question for Don: was this a "promote to fit" (Don trusts him on operational execution but not HR) or a "promote to move" (needed to clear the HR seat)?** Answer shapes how much weight to give his interview inputs. If he's a real COO, he's a key ally for execution improvements. If he's parked, calibrate accordingly.
6. **Bailey Shatney — NEW to executive team.** VP of HR. Takes over People functions from Strainick. **Not on the March org chart at all — background unknown.** Stepping into HR at a company with a 2.4 Glassdoor, culture erosion from layoffs, shifted bonuses, forced RTO, and a Houston office shutdown. If she's new and still ramping, she won't have her own baseline — Adam's survey and interview data becomes her onboarding gift. Clarify with Don: internal promotion or outside hire? How much runway before she's expected to move the needle?
...
## REPLACE: Section 9 — Onsite Interview Plan (April 13–15)
...
## REPLACE: Section 8 — Surveys (add Survey 5)
...
**Deployment update:** Building in Microsoft Forms on MM account. Intro message from Chathura (as CDO). Draft message sent to Ana for Chathura's review (April 3 email). Chathura message needs update to reference 5 surveys instead of 4.

---

## ADD: Section 11 updates

### Completed ✅ (add to existing)
- April 3 reorg mapped and analyzed — updated people, interview schedule, hypothesis status
- Survey 5 (AI Adoption & Tooling) instrument designed
- Chathura survey intro message drafted and sent to Ana (April 3 email)
- Microsoft Forms survey build in progress (DevEx draft live: https://forms.cloud.microsoft/r/021mP98Sf9)
- Ana email sent acknowledging reorg, including text-only org chart for working reference
- Don call guide prepared (13 questions across reorg, board deliverable, onsite prep)
- Mermaid.js org chart diagram created for graphical use

### Updated Status
- **Kennedy/Chathura dynamic (Hypothesis D): RESOLVED by org change.** No longer a live variable. Can reference openly in materials.
- **Siegel interview: REMOVED** from onsite schedule.
- **Lodes interview: DEPRIORITIZED** to optional/consulting context only.
- **Strainick interview: REFOCUSED** — now COO operations interview, not HR/culture.
- **Bailey Shatney interview: ADDED** — new VP HR, 30 min on culture/people.
- **Customer Support Lead interview: ADDED** — TBD name, support now under Chathura.
- **Mark Guilarte interview: ADDED** — PMO under Chathura, 30 min.
- **Survey count: 5** (was 4). Chathura's intro message needs to reference the AI & Tooling survey.

---

## ADD: Hypothesis D Update

**Hypothesis D (Unclear Ownership): CONFIRMED — and resolved by structural change.**

The April 3, 2026 reorg confirmed that formal authority (Kennedy/CTO) and operational authority (Chathura) were misaligned — Don resolved this by giving Chathura formal CDO authority over all engineering, product, design, PMO, and support, while narrowing Kennedy to AI/innovation only.

This is a pre-onsite finding: the organizational structure was changed specifically to resolve the authority misalignment. The onsite should validate whether the *operational* reality has caught up to the *structural* change — i.e., are teams actually reporting through Chathura's chain, or is there residual Kennedy-era routing?

---

## Akshay Bhasin — Scope Clarification Needed

The March org chart listed Bhasin as "QE Lead" under Chathura with ~7 QE engineers. The April org chart shows "Akshay Bhasin (Pmts, 18)" — Payments with 18 people. This is either:
1. A scope expansion (Bhasin absorbed the Payments engineering org), or
2. A relabeling (Payments was always his scope and the March chart was incomplete)

Either way, 18 people in Payments is a significant org. The Payments codebase (madpayments) is architecturally the cleanest in the company. Clarify Bhasin's actual scope and history in the onsite interview.

---

## IT Director — Clarification Needed

The March org chart and original state doc listed **Jorge Maltes** as Director of Information Technology (reporting to Strainick). The April org chart shows **Rosen Georgiev** under IT (Strainick). Rosen was previously identified as the Jira/Confluence admin. Either Jorge left/was moved and Rosen absorbed IT, or the org chart is showing a different level. Clarify — this matters because IT now reports through the COO, not CTO, and whoever runs IT is Adam's contact for infrastructure access and tooling governance.

---

## Strainick Interview — Recalibration Note

The Strainick interview shifted from 30 min on HR/culture to 45 min on COO operations. But there's a secondary purpose now: **validate whether Strainick is in the seat to stay.** If Don's answer on the call reveals this was a "promote to move," the interview focus should shift toward documenting the customer operations chain (Account Mgmt → Onboarding → Delivery → IT) as a process map rather than relying on Strainick's strategic perspective. The process map is durable regardless of who's in the seat.

## Bailey Shatney Interview — Framing Note

Position Adam's deliverables as a potential resource for Bailey. If she's new and ramping, the Westrum Culture survey baseline, Glassdoor data, and interview themes on culture/retention are exactly what she needs to build her own 90-day plan. This creates a natural ally and a reason for Bailey to invest in the interview rather than being guarded with an outside consultant 10 days into a reorg.
